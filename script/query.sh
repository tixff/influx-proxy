...
curl -G 'http://127.0.0.1:7076/query?db=test' --data-urlencode 'q=show TAG from cpu1'
curl -G 'http://127.0.0.1:7076/query?db=test' --data-urlencode 'q=show TAG values from '
curl -G 'http://127.0.0.1:7076/query?db=test' --data-urlencode 'q=show field KEYS fr'
curl -G 'http://127.0.0.1:7076/query?db=test' --data-urlencode 'q=show series from'
curl -G 'http://127.0.0.1:7076/query?db=test' --data-urlencode 'q=show measurement'
curl -G 'http://127.0.0.1:7076/query?db=test' --data-urlencode 'q=show stat'
curl -G 'http://127.0.0.1:7076/query?db=test' --data-urlencode 'q=drop'
curl -G 'http://127.0.0.1:7076/query?db=test' --data-urlencode 'q=delete from '
curl -G 'http://127.0.0.1:7076/query?db=test' --data-urlencode 'q=drop series'
curl -G 'http://127.0.0.1:7076/query?db=test' --data-urlencode 'q=drop series from'
curl -G 'http://127.0.0.1:7076/query?db=test' --data-urlencode 'q=drop measurement'
